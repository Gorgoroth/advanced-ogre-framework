...
void AppStateManager::start(AppState* state)
{
  ...
  while(!m_bShutdown)
  {
    ...
    {
      startTime = AdvancedOgreFramework::getSingletonPtr()->m_pTimer->getMillisecondsCPU();
      ...
      timeSinceLastFrame = AdvancedOgreFramework::getSingletonPtr()->m_pTimer->getMillisecondsCPU() - startTime;
    }
    else
    {
